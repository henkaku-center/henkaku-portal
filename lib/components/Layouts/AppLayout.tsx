                                    ...
                                    <div></div>
                                                ...
                                                >
                                                    <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
                                                        {/* once signed in, no logouts due to NextAuth's current issue refreshing session token preventing second login 
                                                        {status == 'authenticated' ? (
                                                            <Menu.Item>
                                                                {({ active }) => (
                                                                    <a
                                                ...
                                                <a
                                                    className={classNames(
                                                        item.href === currentPath
                                                            ? 'border-b border-indigo-600 text-neutral-400'
                                        ...
                                        NAV_ITEMS.map((item) => (
                                            <Link key={item.title} href={item.href}>
                                                <a
                                                    className={classNames(
                                                        item.href === currentPath
                                                            ? 'border-b border-indigo-600 text-neutral-300'
                                                            : ' hover:border-b  hover:border-gray-200 text-neutral-300 ',
                                                        'group flex items-center px-2 py-2 leading-6 font-medium'
                                                    )}
                                                    aria-current={
